    ...
    plugin(function ({ addBase, config }) {
      addBase({
        ...
        ':root': {
          ...
          '--tw-gray-500': config('theme.colors.gray.500'),
          '--tw-zinc-500': config('theme.colors.zinc.500'),
          '--tw-neutral-500': config('theme.colors.neutral.500'),
          '--tw-stone-500': config('theme.colors.stone.500'),
          '--tw-red-500': config('theme.colors.red.500'),
          '--tw-orange-500': config('theme.colors.orange.500'),
          '--tw-amber-500': config('theme.colors.amber.500'),
          '--tw-yellow-500': config('theme.colors.yellow.500'),
          '--tw-olive-500': config('theme.colors.olive.500'), // Custom
          '--tw-lime-500': config('theme.colors.lime.500'),
          '--tw-green-500': config('theme.colors.green.500'),
          '--tw-emerald-500': config('theme.colors.emerald.500'),
          '--tw-teal-500': config('theme.colors.teal.500'),
          '--tw-cyan-500': config('theme.colors.cyan.500'),
          '--tw-sky-500': config('theme.colors.sky.500'),
          '--tw-blue-500': config('theme.colors.blue.500'),
          '--tw-indigo-500': config('theme.colors.indigo.500'),
          '--tw-violet-500': config('theme.colors.violet.500'),
          '--tw-purple-500': config('theme.colors.purple.500'),
          '--tw-fuchsia-500': config('theme.colors.fuchsia.500'),
          '--tw-pink-500': config('theme.colors.pink.500'),
          '--tw-rose-500': config('theme.colors.rose.500'),
          '--tw-brown-500': config('theme.colors.brown.500'), // Custom
          '--tw-light': config('theme.colors.light'), // Custom
          '--tw-dark': config('theme.colors.dark') // Custom
        },
